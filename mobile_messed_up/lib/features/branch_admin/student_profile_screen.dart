  ...
  Future<void> _deleteStudent() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Are you sure you want to permanently delete this student? This action cannot be undone.'),
        actions: [
    ...
    if (confirmed == true) {
      ...
      try {
        await ApiService.delete('/students/${widget.studentId}/permanent');
        if (mounted) {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: OutlinedButton.icon(
                ...
                label: const Text('Permanently Delete Student', style: TextStyle(color: Colors.red)),
